...
public class HTTPD {
    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files) {
        ...
        return serveFile(uri, header, myRootDir, myAnotherRootDirs, true);
    }
        ...
        myThread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    Log.e("NanoHTTPD", "XXXXXXXXXXXXXXXX  server io error\n");
                }
            }
        });
...
*/
    ...
    private List<File> myAnotherRootDirs;
     ...
     */
    public Response serveFile(String uri, Properties header, File homeDir, List<File> otherHomeDirs,
        ...
        if (res == null && !f.exists()) {
            ...
            for (File other : otherHomeDirs) {
                f = new File(other, uri);
                if (f != null && f.exists()) {
                    findFile = true;
                    //跳出循环，继续执行
                    break;
        ...
        if (res == null && f.isDirectory()) {
            ...
            if (res == null) {
                ...
                if (new File(f, "index.html").exists())
                    ...
                    String[] files = f.list();
                    String msg = "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"><title>文件服务</title></head><body><h1>Directory " + uri + "</h1><br/>";
