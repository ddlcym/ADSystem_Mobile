...
public class AesUtils {
    ...
    private static final String keyBytes = "cdwlgsrjcpb12345";
    ...
    *加密
    */
    public static String randomEncrypt(String content, String password){
            //加密之后的字节数组,转成16进制的字符串形式输出
        return parseByte2HexStr(encrypt(content, password + "000000000000"));
    }

    /**
    *解密
    */
    public static String randomDecrypt(String content, String password){
            //解密之前,先将输入的字符串按照16进制转成二进制的字节数组,作为待解密的内容输入
        byte[] b = decrypt(parseHexStr2Byte(content), password + "000000000000");
        return new String(b);
    }
    ...
    public static void test1(){
        ...
        String pStr = fixEncrypt(content );
        System.out.println("加密前："+content);
        System.out.println("加密后:" + pStr);

        String postStr = fixDecrypt(pStr);
